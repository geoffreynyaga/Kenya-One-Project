...
export const requirementFields: FieldSpec[] = [
  ...
  },
  {
    ...
    source: "seed",
    cell: "B21",
    body: "Best-rate-of-climb speed the climb requirement is evaluated at, carried from the climb workbook.",
  ...
  },
  {
    ...
    source: "seed",
    cell: "B26",
    body: "Propeller efficiency at cruise altitude, carried from the take-off workbook. Converts thrust required into brake horsepower.",
